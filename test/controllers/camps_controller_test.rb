...
class CampsControllerTest < ActionController::TestCase
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post :create, camp: { max_age: @camp.max_age, min_age: @camp.min_age, name: @camp.name, price: @camp.price, reg_limit: @camp.reg_limit, theme: @camp.theme }
    end
  ...
  test "should update camp" do
    patch :update, id: @camp, camp: { max_age: @camp.max_age, min_age: @camp.min_age, name: @camp.name, price: @camp.price, reg_limit: @camp.reg_limit, theme: @camp.theme }
    assert_redirected_to camp_path(assigns(:camp))
  end
